		...
		public class AppBarInfo
		{
			...
			public void GetPosition(string strClassName, string strWindowName)
			{
				...
				if (hWnd != IntPtr.Zero)
				{
					...
					{
						throw new SynapseCoreException("Failed to communicate with the given AppBar");
					}
				}
				else
				{
                    throw new SynapseCoreException("Failed to find an AppBar that matched the given criteria");
				}
			}
