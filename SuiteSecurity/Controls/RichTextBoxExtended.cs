...
namespace SynapseCore.Controls
{
	...
	public class RichTextBoxExtended : System.Windows.Forms.UserControl
	{
		...
		public void ChangeFontStyle(FontStyle style, bool add)
		{
			...
			if (   style != FontStyle.Bold
				...
				&& style != FontStyle.Underline)
					throw new  System.ArgumentException("Unsupported value for ChangeFontStyle", "style");
		...
		public void ChangeFontSize(float fontSize)
		{
			...
			if (fontSize <= 0.0)
                throw new System.ArgumentException("Unsupported value for ChangeFontSize", "fontSize");
