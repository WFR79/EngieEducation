...
using SynapseCore.Controls.FormStyling;
...
#endif
    public class SynapseCustomBorderForm : FormWithNonClientArea
	{
        ...
        public SynapseCustomBorderForm()
		{
        ...
        internal FormStyle ActiveFormStyle
		{
