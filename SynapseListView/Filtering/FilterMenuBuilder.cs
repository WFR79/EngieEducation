...
namespace SynapseAdvancedControls {
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
        static public Bitmap ClearFilteringImage = SynapseAdvancedControls.Properties.Resources.ClearFiltering;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilteringImage = SynapseAdvancedControls.Properties.Resources.Filtering;
